      ...
      <div className="nosotros__container" id={sectionIds.nosotros}>
        <div className="nosotros__introduction">
          ...
          <h2 className="nosotros__inntroductionTittle">
            “Nuestro objetivo es mejorar la forma en la que viajamos y conocemos
            el mundo.”
          </h2>
        ...
        <div className="nosotros__main">
          <div className="nosotros__mainText">
            ...
            <p className="nosotros__mainTextP">
              ...
              organizar y reservar su viaje de forma fácil y rápida con la ayuda
              de las agencias de viaje.
            </p>
            <p className="nosotros__mainTextPColor">
              Si eres una agencia de viajes y estas pensando en como afrontar
              los nuevos retos que se presentan, quédate y echa un vistazo.
            </p>
            <div style={{ marginTop: "60px" }}>
              <button className="nosotros__button" onClick={open}>
                Ver Presentación
                <Play
                  style={{
                    width: "20px",
